...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'Trade_average', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('monthAverage', self.gf('django.db.models.fields.DecimalField')(max_digits=16, decimal_places=8)),
            ('dayAverage', self.gf('django.db.models.fields.DecimalField')(max_digits=16, decimal_places=8)),
        ))
        db.send_create_signal(u'Trade', ['Average'])


    def backwards(self, orm):
        # Deleting model 'Average'
        db.delete_table(u'Trade_average')
