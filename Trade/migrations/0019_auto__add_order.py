...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Order'
        db.create_table(u'Trade_order', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('OrderId', self.gf('django.db.models.fields.IntegerField')(unique=True, max_length=20)),
            ('Price', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=16, decimal_places=8)),
            ...
            ('OrderType', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal(u'Trade', ['Order'])
    ...
    models = {
        ...
        u'Trade.bitstampuser': {
            ...
            'Order': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['Trade.Order']", 'symmetrical': 'False', 'blank': 'True'}),
